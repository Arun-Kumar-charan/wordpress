...
if(!function_exists('weaversweb_ftn_options')){
	function weaversweb_ftn_options(){
		...
		/* Icon Link */
			...
			array("name" => "Banner Section",
			"type" => "heading"),
			
			array("name" => "Choose About us page banner",
			"desc" => "Optimal size",
			"id"   => "About_us_banner",
			"std"  => "",
			"type" => "upload"),
			array("name" => "Choose Product page banner",
			"desc" => "Optimal size",
			"id"   => "product_page_banner",
			"std"  => "",
			"type" => "upload"),
			array("name" => "Choose Receipes page banner",
			"desc" => "Optimal size",
			"id"   => "Receipes_page_banner",
			"std"  => "",
			"type" => "upload"),
			array("name" => "Choose Contact us page banner",
			"desc" => "Optimal size",
			"id"   => "Contact_us_page_banner",
			"std"  => "",
			"type" => "upload"),
			/* ---------------------------------------------------------------------------- */
			);		
